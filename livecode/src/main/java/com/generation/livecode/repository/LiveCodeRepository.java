...
public interface LiveCodeRepository extends JpaRepository<LiveCode, Long> {
	...
	public List<LiveCode> findAllById(Long id);
	
	public List<LiveCode> findAllByqtdParticipantes(Long qtdParticipantes);
	
	public List<LiveCode> findAllByConvidade(Boolean convidade);
	
	public List<LiveCode> findAllByAtivo(Boolean ativo);
